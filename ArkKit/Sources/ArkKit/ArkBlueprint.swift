 ...
 */
public struct ArkBlueprint<ExternalResources: ArkExternalResources> {
    ...
    public init(frameWidth: Double, frameHeight: Double) {
        self.frameWidth = frameWidth
        self.frameHeight = frameHeight
    }

    public func setup(_ fn: @escaping ArkStateSetupDelegate) -> Self {
    ...
    public func withAudio(_ soundMapping: [ExternalResources.AudioEnum: any Sound]) -> Self {
    ...
    public func forEachTick(_ callback: @escaping GameLoopActionCallback<ExternalResources>) -> Self {
        var newSelf = self
        var newRules = rules
    ...
    public func supportNetworkMultiPlayer(roomName: String, numberOfPlayers: Int) -> Self {
        var newSelf = self
    ...
    public func setupPlayer(_ fn: @escaping ArkStateSetupDelegate) -> Self {
    ...
    public func setRole(_ role: ArkPeerRole) -> Self {
        var newSelf = self
