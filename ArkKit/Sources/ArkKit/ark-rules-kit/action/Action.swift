...
public typealias ActionCallback<Event: ArkEvent, ExternalResources: ArkExternalResources> =
(Event, ArkActionContext<ExternalResources>) -> Void

public typealias GameLoopActionCallback<ExternalResources: ArkExternalResources> =
