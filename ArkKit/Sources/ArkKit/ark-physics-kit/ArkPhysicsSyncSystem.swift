 ...
 */
public class ArkPhysicsSyncSystem: UpdateSystem {
    var active: Bool
...
public protocol ArkCollisionEventProtocol: ArkEvent {
    init(eventData: ArkCollisionEventData, priority: Int?)
}

public struct ArkCollisionEventData: ArkEventData {
    public var name = ""
    public var entityA: Entity
    public var entityACategoryBitMask: UInt32
    public var entityB: Entity
    public var entityBCategoryBitMask: UInt32
}

public struct ArkCollisionEndedEvent: ArkCollisionEventProtocol {
    public static var id = UUID()
    public var eventData: ArkCollisionEventData
    public var priority: Int?

    public init(eventData: ArkCollisionEventData, priority: Int? = 10) {
        self.eventData = eventData
    }
}

public struct ArkCollisionBeganEvent: ArkCollisionEventProtocol {
    public static var id = UUID()
    public var eventData: ArkCollisionEventData
    public var priority: Int?
