 ...
 */
public class Ark<View, ExternalResources: ArkExternalResources>: ArkProtocol {
    public let rootView: any AbstractRootView<View>
    public var arkState: ArkState
    ...
    public init(rootView: any AbstractRootView<View>,
