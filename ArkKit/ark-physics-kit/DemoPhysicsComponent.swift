...
// TODO: Abstract this to become dev friendly
import Foundation
...
let demoEnemyPhysicsComponent = PhysicsComponent(shape: demoDummyShape,
...
let demoPlayerPhysicsComponent = PhysicsComponent(shape: demoDummyShape,
                                              radius: demoDummyRadius,
...
let demoCoinPhysicsComponent = PhysicsComponent(shape: demoDummyShape,
                                            radius: demoDummyRadius,
